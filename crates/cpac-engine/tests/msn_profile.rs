...
fn msn_overhead_track2() {
    ...
    let overhead_pct = ((msn_duration.as_secs_f64() / baseline_duration.as_secs_f64()) - 1.0) * 100.0;
    ...
    assert!(overhead_pct < 5.0, "MSN overhead on Track 2 data: {:.2}%", overhead_pct);
}
...
{"field1":"third","field2":789,"field3":"test"}"#.repeat(100);
    ...
    println!("MSN percentage: {:.1}%", (msn_time.as_secs_f64() / total_time.as_secs_f64()) * 100.0);
}
